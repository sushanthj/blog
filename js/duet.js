...
(function ($) {
	...
	History.Adapter.bind(window,'statechange',function(){
		...
		$('.page-loader').load( state.hash + ' .page__content', function() {
			...
			setTimeout( function() {
				...
				// Toggle dark theme based on page content
				if ($('.page__content').attr('data-theme') === 'dark') {
					$('body').addClass('kb-dark');
				} else {
					$('body').removeClass('kb-dark');
				}
	...
	function pageFunctions() {
		...
		// Re-render Mermaid diagrams after AJAX page load
